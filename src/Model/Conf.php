...
use ErrorException;
use Psancho\Galeizon\Model\Conf\App as ConfApp;
...
{
    public protected(set) ?ConfApp $app = null;
    ...
    {
        if (property_exists($raw, 'app') && is_object($raw->app)) {
            $this->app = ConfApp::fromObject($raw->app, self::ROOT_PASS);
        }
